...
We actively maintain the latest version of Replane. Security updates are only provided for the latest release.
...
We take security seriously at Replane and appreciate your help in disclosing issues responsibly.

To report a security vulnerability, please email **tilyupo@gmail.com** with the following:

- Description of the issue
- Steps to reproduce (if applicable)
- Your environment and version of Replane
