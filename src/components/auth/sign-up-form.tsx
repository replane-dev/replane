...
import {z} from 'zod';
import {EmailDomainNotice, ErrorBanner, PasswordInput, PasswordStrengthIndicator} from './shared';
...
export function SignUpForm({callbackUrl, allowedEmailDomains}: SignUpFormProps) {
  const trpc = useTRPC();
