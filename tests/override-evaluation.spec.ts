...
describe('Override Evaluation', () => {
  ...
  describe('Integration Tests', () => {
    it('should create config with overrides and evaluate them', async () => {
      ...
      // Test base value
      const baseResult = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'max_items_config',
        projectId: fixture.projectId,
      ...
      const vipResult = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'max_items_config',
        projectId: fixture.projectId,
        environmentId: fixture.productionEnvironmentId,
      ...
      const premiumResult = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'max_items_config',
        projectId: fixture.projectId,
        environmentId: fixture.productionEnvironmentId,
      ...
      const regularResult = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'max_items_config',
        projectId: fixture.projectId,
        environmentId: fixture.productionEnvironmentId,
    ...
    it('should update overrides via updateConfig', async () => {
      ...
      const enabledResult = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'feature_flag',
        projectId: fixture.projectId,
        environmentId: fixture.productionEnvironmentId,
      ...
      const disabledResult = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'feature_flag',
        projectId: fixture.projectId,
        environmentId: fixture.productionEnvironmentId,
    ...
    it('should work with type casting in production', async () => {
      ...
      const adult = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'age_restricted',
        projectId: fixture.projectId,
        environmentId: fixture.productionEnvironmentId,
        context: {age: 25},
      ...
      const minor = await fixture.proxy.useCases.getConfigValue(GLOBAL_CONTEXT, {
        name: 'age_restricted',
        projectId: fixture.projectId,
        environmentId: fixture.productionEnvironmentId,
        context: {age: 15},
